---
name: apex-build
description: Builds Apex classes, triggers, and test classes from requirements. Invokes the sf-apex-builder agent after gathering context and loading the apex-patterns skill. Use this command whenever a user wants to write Apex code.
---
...
2. Load the `apex-patterns` skill before handing off to the agent.
