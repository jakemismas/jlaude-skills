...
const DESTRUCTIVE_BASH = [
  { pattern: /(?<!(?:git|npm|yarn|pnpm|bun|brew|apt|apt-get|dnf|docker|kubectl|helm)\s)\brm\s+(-[^\s]*\s+)*/, reason: "rm command detected", suggestion: "Move files to .claude-working/ instead of deleting" },
