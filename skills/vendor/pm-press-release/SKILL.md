...
This is not a marketing artifact for launch dayâ€"it's a planning tool that asks "If we shipped this perfectly, how would we explain it to the world?"
...
- **Not feature-centric:** Don't list specsâ€"focus on customer outcomes
...
- **Customer problem mentioned:** Don't jump to solutionâ€"name the problem first
...
```markdown
[Product/feature] addresses this by [how it solves the problemâ€"focus on outcomes]. [Quote from company leader]: "[Insert quote that emphasizes customer value, not features]."
```
...
**Consequence:** Customers don't care about featuresâ€"they care about outcomes.
...
**Fix:** Make it customer-focused: "Business owners shouldn't spend weekends processing invoicesâ€"they should spend that time with family."
...
### Related Skills
- `skills/problem-statement/SKILL.md` â€" Defines the customer problem the press release highlights
- `skills/positioning-statement/SKILL.md` â€" Informs the differentiation and value proposition
- `skills/proto-persona/SKILL.md` â€" Defines the target customer mentioned in the press release
- `skills/jobs-to-be-done/SKILL.md` â€" Informs the customer benefits and outcomes
