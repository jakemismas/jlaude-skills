...
intent: >-
  Create a comprehensive customer journey map that visualizes how customers interact with your brand across all stagesâ€"from awareness to loyaltyâ€"documenting their actions, touchpoints, emotions, KPIs, business goals, and teams involved at each stage. Use this to identify pain points, align cross-functional teams, and systematically improve the customer experience to achieve business objectives.
type: component
...
scenarios:
  ...
  - "Create a journey map for a PM leader evaluating our skills repo â€" from discovery through loyalty"
...
This is not a user flow diagramâ€"it's a strategic artifact that combines customer empathy with business metrics to drive actionable improvements.
...
```markdown
**Customer Experience:**
- [Emotion 1: e.g., "Curious but skepticalâ€"'Is this actually better than spreadsheets?'"]
- [Emotion 2: e.g., "Overwhelmed by optionsâ€"'Too many tools, how do I choose?'"]
- [Emotion 3: e.g., "Hopeful but cautiousâ€"'Could this save me time?'"]
```

**Quality checks:**
- **Authentic:** Use customer quotes from research when possible
- **Emotional:** Capture feelings, not just thoughts
- **Specific:** Not "interested" but "curious but skepticalâ€"worried about setup time"
...
- **Update regularly:** Customer behavior changesâ€"revisit the map quarterly
...
### Related Skills
- `skills/proto-persona/SKILL.md` â€" Defines the persona for the journey map
- `skills/jobs-to-be-done/SKILL.md` â€" Informs customer actions and goals
- `skills/problem-statement/SKILL.md` â€" Identifies pain points at each stage
- `skills/user-story-mapping/SKILL.md` â€" Complementary (story mapping focuses on product usage, journey mapping covers all touchpoints)

### External Frameworks
- NNGroup, *Customer Journey Mapping* (2016) â€" Foundational framework
- Carnegie Mellon University, *Product Management Curriculum* â€" Academic approach
- Chris Risdon & Patrick Quattlebaum, *Orchestrating Experiences* (2018) â€" Journey mapping for service design
