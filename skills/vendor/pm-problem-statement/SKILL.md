...
This is not a requirements docâ€"it's a human-centered problem narrative that ensures you're solving a problem worth solving.
...
- When you haven't done any user research yet (don't guessâ€"interview first)
...
### Related Skills
- `skills/jobs-to-be-done/SKILL.md` â€" Informs the "Trying to" and "But" sections
- `skills/proto-persona/SKILL.md` â€" Defines the "I am" persona
- `skills/positioning-statement/SKILL.md` â€" Problem statement informs positioning
- `skills/user-story/SKILL.md` â€" Problem statement guides story prioritization

### External Frameworks
- Clayton Christensen, *Jobs to Be Done* â€" Origin of outcome-focused problem framing
- Osterwalder & Pigneur, *Value Proposition Canvas* â€" Customer pains/gains/jobs
- Dave Gray, *Empathy Mapping* â€" Emotional framing techniques
