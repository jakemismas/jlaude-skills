...
This is not surface-level researchâ€"it's strategic intelligence gathering focused on product management perspectives and executive vision.
...
- **Not surface scraping:** Go deeper than "About Us" pagesâ€"find executive interviews, product blogs, earnings transcripts
...
- [Example: "IC track: PM â†' Senior PM â†' Staff PM â†' Principal PM. Manager track: PM â†' Group PM â†' Director â†' VP."]
```
...
**Fix:** Go deeperâ€"find executive interviews, engineering blogs, product philosophy posts.
...
### Related Skills
- `skills/positioning-statement/SKILL.md` â€" Use company research to understand competitive positioning
- `skills/pestel-analysis/SKILL.md` â€" Company research informs market context
- `skills/proto-persona/SKILL.md` â€" Executive quotes may reveal target personas
