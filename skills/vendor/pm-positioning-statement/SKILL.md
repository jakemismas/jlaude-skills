...
This is not a tagline or elevator pitchâ€"it's a strategic clarity tool that forces you to make hard choices about target, need, and differentiation.
...
- **Not a tagline:** "Positioning" â‰  "Nike: Just Do It"
...
- **that need** [statement of underserved needâ€"focus on pains, gains, JTBD]
- [product or service name]
- **is a** [product category]
- **that** [benefit statementâ€"focus on outcomes, not features]
```
...
- **Unlike** [primary competitor or competitive alternative]
- [product or service name]
- **provides** [unique differentiationâ€"outcomes, not features]
```
...
### Related Skills
- `skills/problem-statement/SKILL.md` â€" Defines the problem positioning addresses
- `skills/jobs-to-be-done/SKILL.md` â€" Informs the "that need" statement
- `skills/proto-persona/SKILL.md` â€" Defines the "For [target]" segment
- `skills/press-release/SKILL.md` â€" Positioning informs press release messaging

### External Frameworks
- Geoffrey Moore, *Crossing the Chasm* (1991) â€" Origin of this framework
- April Dunford, *Obviously Awesome* (2019) â€" Modern positioning playbook
- Al Ries & Jack Trout, *Positioning: The Battle for Your Mind* (1981) â€" Foundational positioning theory
