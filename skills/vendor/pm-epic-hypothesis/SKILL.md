...
This is not a requirements specâ€"it's a hypothesis you're testing, not a feature you're committed to shipping.
...
- **Not output-focused:** "Ship feature X by Q2" misses the pointâ€"did it achieve the outcome?
...
- **Cheap:** Avoid full engineering buildsâ€"use prototypes, manual processes, or existing tools
...
**Consequence:** You've committed to building before validating. Not a hypothesisâ€"it's a feature commitment.
...
**Consequence:** Experiments are theaterâ€"you're going to build it regardless of results.
...
### Related Skills
- `skills/problem-statement/SKILL.md` â€" Hypothesis should address a validated problem
- `skills/proto-persona/SKILL.md` â€" Defines the "for [persona]" section
- `skills/jobs-to-be-done/SKILL.md` â€" Informs the "then we will" outcome
- `skills/user-story/SKILL.md` â€" Validated epics decompose into user stories
- `skills/user-story-splitting/SKILL.md` â€" How to break validated epics into stories

### External Frameworks
- Tim Herbig, *Lean UX Hypothesis Statement* â€" Origin of if/then hypothesis format
- Jeff Gothelf & Josh Seiden, *Lean UX* (2013) â€" Hypothesis-driven product development
- Alberto Savoia, *Pretotype It* (2011) â€" Lightweight experiments to validate ideas
- Eric Ries, *The Lean Startup* (2011) â€" Build-Measure-Learn cycle
