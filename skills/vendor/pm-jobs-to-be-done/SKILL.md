...
This is not a surveyâ€"it's a structured lens for understanding *why* customers "hire" your product and what would make them "fire" it.
...
- **Separates job from solution:** "Communicate with my team" (job) â‰  "email" (solution)
...
- **Prioritizes by intensity:** Not all pains are equalâ€"focus on the most acute
...
- **Not generic:** "Be more productive" is too vagueâ€"dig into *which* tasks and *why*
...
- **Solution-agnostic:** Don't say "use email to communicate"â€"say "communicate with remote teammates"
...
- **Rooted in research:** Don't fabricate emotionsâ€"use customer quotes
...
**Fix:** Ask "Why?" 5 times. "I need Slack" â†' "Why?" â†' "To communicate with my team" â†' "Why?" â†' "To get quick answers" â†' "Why?" â†' "To avoid project delays."
...
**Fix:** Get specific. "Save time" â†' "Reduce time spent generating monthly reports from 8 hours to 1 hour."
...
### Related Skills
- `skills/proto-persona/SKILL.md` â€" Defines who has these jobs/pains/gains
- `skills/problem-statement/SKILL.md` â€" JTBD informs the "Trying to" and "But" sections
- `skills/positioning-statement/SKILL.md` â€" JTBD informs the "that need" statement

### External Frameworks
- Clayton Christensen, *Competing Against Luck* (2016) â€" Origin of Jobs-to-be-Done theory
- Tony Ulwick, *Outcome-Driven Innovation* (2016) â€" Quantifying jobs and outcomes
- Alexander Osterwalder, *Value Proposition Canvas* (2014) â€" Customer jobs/pains/gains framework
