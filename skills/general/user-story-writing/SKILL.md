...
Every acceptance criterion should map directly to at least one test case row in the Canidium test case template. If an AC cannot be translated into concrete test steps and an expected result, it is not a real criterion.

## Workflow

1. Confirm the actor, action, and achievement with the customer or PM before drafting criteria. This is the scope conversation.
2. Draft acceptance criteria as present-tense behavior statements.
3. Check each criterion is testable by sketching the test case in your head.
4. Size-check: can this finish in a sprint? More than 7-8 ACs? Split if so.
5. Add to Jira, the backlog, or the requirements doc.

## References

- Canidium User Story PowerPoint (internal, linked from LPMO Portal)
- Scrum Lessons Learned deck (internal)
- LPMO Portal quick guide: https://sites.google.com/canidium.com/lpmo/quick-guides/user-stories
